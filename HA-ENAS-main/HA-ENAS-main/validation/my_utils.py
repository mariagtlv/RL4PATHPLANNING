...
def Cifar224_data(root='data/CIFAR10', train_batch_size=64, test_batch_size=100):
    # Data
...
def Cifar224_data_augment(root='/data/CIFAR10', train_batch_size=64, test_batch_size=100):
    # Data
    print('==> Preparing Cifar224 data..')
    transform_train = transforms.Compose([
        transforms.Resize(224),
