...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, layers, criterion, output_weights, search_space, steps, geno):
    ...
    def _initialize_alphas(self):
        self.alphas_mixed_op = self.geno['op'].cuda()
        self.alphas_output = torch.Tensor([[1., 1., 1., 1., 1., 1.]]).cuda()
        self.alphas_inputs = self.geno['edge']
        ...
        for edge in self.alphas_inputs:
            self._arch_parameters.append(edge.cuda())
