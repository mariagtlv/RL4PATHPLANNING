...
parser = argparse.ArgumentParser(description='PyTorch ImageNet Clean Evaluation')
parser.add_argument('--gpus', type=list, default=[0, 1], help='gpu device id')
...
def main():
    ...
    model.load_state_dict(torch.load('./model.pt', map_location=main_device))
