...
parser.add_argument('--test-batch-size', type=int, default=200, metavar='N', help='input batch size for testing (default: 200)')
...
def main():
    ...
    model.load_state_dict(torch.load('./model.pt', map_location=torch.device('cuda:' + str(args.gpu))), strict=False)
    model = model.cuda()
